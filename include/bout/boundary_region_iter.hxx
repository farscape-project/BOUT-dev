...
inline BoundaryRegionIterFCI
begin(const BoundaryRegionFCI& reg) {
  return BoundaryRegionIterFCI(&reg, true);
}
inline BoundaryRegionIterFCI
end(const BoundaryRegionFCI& reg) {
  return BoundaryRegionIterFCI(&reg, false);
}

template <bool isX>
inline BoundaryRegionIterXY<isX>
begin(const BoundaryRegionXY<isX>& reg) {
  return BoundaryRegionIterXY<isX>(&reg, true);
}
template <bool isX>
inline BoundaryRegionIterXY<isX>
end(const BoundaryRegionXY<isX>& reg) {
